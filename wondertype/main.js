...
var Dev1 = /** @class */ (function (_super) {
    ...
    function Dev1(name, age, salary, designation) {
        ...
        _this.salary = (_super.prototype.display.call(_this) / 100) * 20;
        _this.salary = _this.salary + (_super.prototype.display.call(_this) / 100) * 20;
        return _this;
    }
    return Dev1;
}(Employee));
var Tester = /** @class */ (function (_super) {
    ...
    function Tester(name, age, salary, designation) {
        ...
        _this.salary = (_super.prototype.display.call(_this) / 100) * 10;
        _this.salary = _this.salary + (_super.prototype.display.call(_this) / 100) * 10;
        return _this;
    }
    return Tester;
}(Employee));
var Manager = /** @class */ (function (_super) {
    ...
    function Manager(name, age, salary, designation) {
        var _this = _super.call(this, name, age, salary, designation) || this;
        console.log('tester old salary' + _this.salary);
        _this.salary = (_this.salary / 100) * 30;
        _this.salary = _this.salary + (_super.prototype.display.call(_this) / 100) * 30;
        return _this;
    }
    return Manager;
}(Employee));
