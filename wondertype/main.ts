...
class Dev1  extends Employee{
    ...
    constructor(name:string,age:number,salary:number,designation:string){
        ...
        // this.salary = (super.display()/100)*20;
        // this.salary = this.salary+(super.display()/100)*20;
    }
}
class Tester   extends Employee{
    ...
    constructor(name:string,age:number,salary:number,designation:string){
        ...
        // this.salary = (super.display()/100)*10;
        // this.salary = this.salary+(super.display()/100)*10;
...
class Manager  extends Employee {
    constructor(name:string,age:number,salary:number,designation:string){
        super(name,age,salary,designation)
        // console.log('tester old salary'+this.salary);
        this.salary = (this.salary/100)*30;
        // this.salary = this.salary+(super.display()/100)*30;
